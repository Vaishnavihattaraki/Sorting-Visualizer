...
async function mergeSort(array) {
  ...
  let merged = await merge(left, right, array);
  for (let i = 0; i < merged.length; i++) {
    bars[i].style.height = merged[i] * heightFactor + "px";
...
sort_btn.addEventListener("click", function () {
  switch (algotouse) {
    case "bubble":
      ...
      break;
    case "merge":
      if (confirm("Merge Sort is not visualized properly. Do you want to continue?")) {
